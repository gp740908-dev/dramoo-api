...
async function run() {
  try {
    const res = await axios.get('https://www.reelshort.com/id/episodes/%2Fepisodes%2Fepisode-2-versi-dub-penipuan-jalanan-legenda-bela-diri-699d1eefa3a7262cff05534b', {
